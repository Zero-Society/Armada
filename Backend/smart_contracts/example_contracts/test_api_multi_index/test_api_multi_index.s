...
_ZN17_test_multi_index27idx64_check_without_storingILy8417982951132398080EEEvy:
	...
	i32.const	$push9=, .L.str.132
	call    	eosio_assert@FUNCTION, $pop8, $pop9
.LBB11_2:
	end_block
	i32.eqz 	$push10=, $11
	i32.const	$push11=, .L.str.97
...
.LBB11_22:
	end_block
	i32.const	$push53=, .L.str.99
	call    	eosio_assert@FUNCTION, $4, $pop53
	i32.const	$push54=, .L.str.124
...
.LBB11_24:
	end_block
	i32.eqz 	$push57=, $11
	i32.const	$push58=, .L.str.100
	call    	eosio_assert@FUNCTION, $pop57, $pop58
	i64.const	$7=, 0
	i64.const	$6=, 59
	i32.const	$11=, .L.str.101
	i64.const	$8=, 0
.LBB11_25:
	loop    	
	block   	
...
.LBB11_183:
	...
	i32.const	$push377=, .L.str.132
	call    	eosio_assert@FUNCTION, $pop376, $pop377
.LBB11_185:
	end_block
	i32.eqz 	$push378=, $11
	i32.const	$push379=, .L.str.117
...
_ZN5eosio11multi_indexILy8417982951132398080EN17_test_multi_index12record_idx64EJNS_10indexed_byILy4589348694149954560EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_secondaryEvEEEEEEEE5eraseERKS2_:
	...
	i32.load	$push0=, 16($1)
	i32.eq  	$push1=, $pop0, $0
	i32.const	$push2=, .L.str.128
	call    	eosio_assert@FUNCTION, $pop1, $pop2
	i64.load	$push3=, 0($0)
	i64.call	$push4=, current_receiver@FUNCTION
	i64.eq  	$push5=, $pop3, $pop4
	i32.const	$push6=, .L.str.129
	call    	eosio_assert@FUNCTION, $pop5, $pop6
	block   	
	i32.const	$push7=, 28
...
.LBB55_28:
	end_block
	i32.const	$push81=, .L.str.127
	call    	eosio_assert@FUNCTION, $11, $pop81
	i32.const	$push82=, .L.str.124
...
.LBB72_45:
	end_block
	i32.const	$push144=, .L.str.127
	call    	eosio_assert@FUNCTION, $12, $pop144
	i32.const	$push145=, .L.str.124
...
_ZN16test_multi_index14idx256_generalEyyy:
	...
	i32.const	$push6=, 1
	i32.const	$push5=, .L.str.136
	call    	eosio_assert@FUNCTION, $pop6, $pop5
	i32.const	$push685=, 1
	i32.const	$push684=, .L.str.136
	call    	eosio_assert@FUNCTION, $pop685, $pop684
	i32.const	$push683=, 1
	i32.const	$push682=, .L.str.136
...
_ZN16test_multi_index32idx64_pass_pk_ref_to_other_tableEyyy:
	...
	i32.const	$push8=, .L.str.132
	call    	eosio_assert@FUNCTION, $pop7, $pop8
	i64.load	$3=, 8($7)
	i64.const	$8=, 59
	i32.const	$7=, .L.str.54
	i64.const	$10=, 0
.LBB100_2:
	loop    	
	block   	
...
_ZN16test_multi_index23idx64_run_out_of_avl_pkEyyy:
	...
	i32.const	$push6=, .L.str.132
	call    	eosio_assert@FUNCTION, $pop5, $pop6
	i64.load	$4=, 8($9)
	i64.const	$10=, 59
	i32.const	$9=, .L.str.54
	i64.const	$12=, 0
.LBB109_2:
	loop    	
	block   	
