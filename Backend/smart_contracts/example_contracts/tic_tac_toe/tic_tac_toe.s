...
_ZN5eosio18unpack_action_dataIN11tic_tac_toe6createEEET_v:
	...
	.local  	i32, i32, i32
	i32.const	$push16=, 0
	i32.load	$push22=, __stack_pointer($pop16)
	tee_local	$push21=, $2=, $pop22
	copy_local	$3=, $pop21
	block   	
	block   	
	i32.call	$push20=, action_data_size@FUNCTION
	tee_local	$push19=, $1=, $pop20
	i32.const	$push0=, 513
	i32.lt_u	$push1=, $pop19, $pop0
	br_if   	0, $pop1
...
.LBB7_2:
	...
	i32.sub 	$push24=, $2, $pop5
	tee_local	$push23=, $2=, $pop24
	copy_local	$push18=, $pop23
	i32.store	__stack_pointer($pop15), $pop18
.LBB7_3:
	end_block
	...
	i32.const	$push25=, 8
	i32.call	$drop=, memcpy@FUNCTION, $pop14, $pop13, $pop25
	i32.const	$push17=, 0
	i32.store	__stack_pointer($pop17), $3
	.endfunc
.Lfunc_end7:
...
_ZN5eosio18unpack_action_dataIN11tic_tac_toe4moveEEET_v:
	...
	copy_local	$3=, $pop18
	i32.const	$push11=, 0
	i32.store	__stack_pointer($pop11), $2
	block   	
	block   	
	i32.call	$push17=, action_data_size@FUNCTION
	tee_local	$push16=, $1=, $pop17
	i32.const	$push0=, 513
	i32.lt_u	$push1=, $pop16, $pop0
	br_if   	0, $pop1
	i32.call	$2=, malloc@FUNCTION, $1
	br      	1
.LBB13_2:
	...
	i32.const	$push4=, -16
	i32.and 	$push5=, $pop3, $pop4
	i32.sub 	$push21=, $2, $pop5
	tee_local	$push20=, $2=, $pop21
	copy_local	$push15=, $pop20
