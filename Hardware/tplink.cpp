...
//Use this code to send satori stream to server
static char const *endpoint = endpoint;
static char const *appkey = appkey;
...
int main() {
  ...
  unsigned request_id;
  char const *message = "{\"who\":\"TPlink\",\"where\":[34.134358, -118.321506]}";
  char const *channelName = "TP Channel";
